...
public class ProductsController {
    ...
    // BEGIN
    @GetMapping
    public List<ProductDTO> getBySearch(ProductParamsDTO paramsDTO, @RequestParam(defaultValue = "1") int page){
        var spec = specification.build(paramsDTO);
        return productRepository.findAll(spec, PageRequest.of(page - 1, 10)).stream()
